...
namespace Sellora.CatalogService.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914163118_MakeCategoryNamesCaseInsensitive")]
    partial class MakeCategoryNamesCaseInsensitive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sellora.CatalogService.Domain.Entities.Category", b =>
                {
            ...
            modelBuilder.Entity("Sellora.CatalogService.Domain.Entities.ProductBatch", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "ProductId", "BatchCode")
                        .IsUnique()
            ...
            modelBuilder.Entity("Sellora.CatalogService.Domain.Entities.ProductPriceHistory", b =>
                {
                    ...
                    b.HasIndex("CompanyId", "ProductId", "ChangedAt")
                        .HasDatabaseName("ix_product_price_history_company_product_changed_at");

                    b.ToTable("product_price_history", null, t =>
                        {
                            t.HasCheckConstraint("ck_product_price_history_new_price", "new_unit_price > 0");

                            t.HasCheckConstraint("ck_product_price_history_old_price", "old_unit_price > 0");
                        });
                });

            modelBuilder.Entity("Sellora.CatalogService.Domain.Entities.Product", b =>
                {
                    b.HasOne("Sellora.CatalogService.Domain.Entities.Category", "Category")
                        .WithMany("Products")
